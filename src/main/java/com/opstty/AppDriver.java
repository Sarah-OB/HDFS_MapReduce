...
public class AppDriver {
    public static void main(String argv[]) {
        ...
        try {
            ...
            programDriver.addClass("districtsTrees", DistrictsTrees.class, "A map/reduce program that show the distincts districts containing trees.");
            ...
            programDriver.addClass("oldestTree", DistrictOldestTree.class, "A map/reduce program that show the district where is the oldest tree.");
            programDriver.addClass("mostTrees", DistrictMostTree.class, "A map/reduce program that show the district containing the most trees.");
